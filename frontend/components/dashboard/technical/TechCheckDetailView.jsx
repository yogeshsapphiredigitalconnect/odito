  ...
  return (
    ...
    <div className="slide-up">
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
          ...
          <div style={{ 
            ...
            background: currentCheck.status === "critical" ? "rgba(255,56,96,0.12)" : 

                     currentCheck.status === "warning" ? "rgba(255,183,3,0.10)" : 
          ...
          <h2 style={{ fontFamily: "Syne, sans-serif", fontSize: 28, fontWeight: 800, flex: 1, color: "#eef2ff" }}>
          ...
          }}>🗂 {currentCheck.category || 'Technical'}</span>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            color: currentCheck.difficulty === "Easy" ? "#00f5a0" : 

                   currentCheck.difficulty === "Medium" ? "#ffb703" : "#ff3860"

          }}>{currentCheck.difficulty || "Medium"}</div>
      ...
      <div style={{
        ...
        }}>{currentCheck.what || currentCheck.message || currentCheck.detail || 'No description available.'}</div>
        ...
        <div>
            ...
            return (
              ...
              <div 
                ...
                style={{
                  ...
                  ...(isSelected && !isFixed && { background: "rgba(119,48,237,0.07)" })

                }}

                onClick={() => !isFixed && setSelUrl(isSelected ? null : page.url)}
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  }}>{page.issue || 'Issue detected on this page'}</div>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 10 }}>
              ...
              <span style={{ fontSize: "12.5px", fontWeight: 700, color: "#00f5a0" }}>{allFixed}/{pages.length} Fixed</span>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{
                ...
                {fixingUrl ? "🔧 AI Fixing" : selUrl ? "🔍 Selected" : "Fix Assistant"}
                ...
                {fixingUrl ? (
                      ...
                      <div style={{ animation: "fixFadeUp 0.3s ease forwards" }}>
                        ...
                        <div style={{
                          ...
                          <div style={{
                            ...
                            This fix resolves <strong style={{ color: "#eef2ff" }}>{currentCheck.name}</strong> on <strong style={{ color: "#00dfff", fontFamily: "'DM Mono', monospace" }}>{fixingUrl}</strong>. Estimated recovery: <strong style={{ color: "#00f5a0" }}>+{currentCheck.impact || 0}% SEO</strong>. Difficulty: <strong style={{ color: "#eef2ff" }}>{currentCheck.difficulty || "Medium"}</strong>.
                  ...
                  <div>
                    ...
                    <div style={{
                      ...
                      {selUrl ? `Selected: ${selUrl}` : "👆 Select a page from the list to generate a targeted AI fix"}
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        {currentCheck.aiPrompt || 'Generate AI prompt for fixing this issue...'}
              ...
              <div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    {currentCheck.whatToDo || currentCheck.what || 'Follow these steps to fix the issue.'}
              ...
              <div>
                ...
                <div style={{ 
                  ...
                  <div style={{ 
                    ...
                    Our technical team will resolve <strong style={{ color: "#eef2ff" }}>{currentCheck.name}</strong> across all {openUrls.length} affected pages — with QA verification and a before/after report.
      ...
      {showBulkModal && (
        ...
        <div style={{
          ...
          <div style={{
            ...
            }}>Generating fixes for {checked.length} pages — {currentCheck.name}</div>
