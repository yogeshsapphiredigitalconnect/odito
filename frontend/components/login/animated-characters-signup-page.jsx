...
import { Eye, EyeOff, Mail, Sparkles, User, Lock } from "lucide-react";
import { cn } from "@/lib/utils";
import { useAuth } from "@/contexts/AuthContext";
import { signIn } from "next-auth/react";
import { getPaymentIntent, disallowPaymentResume } from "@/utils/paymentUtils";
      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-sm">Join us and start building amazing things</p>
          </div>
