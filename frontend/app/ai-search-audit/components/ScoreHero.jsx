...
export default function ScoreHero({ aiData }) {
  ...
  const scoreColor = score >= 70 ? "#00f5a0" : score >= 50 ? "#ffb703" : "#ff3860";
    ...
    <div className={styles.scoreHero}>
      <div className={styles.scoreHeroRing}>
        <svg width="150" height="150" viewBox="0 0 120 120">
          ...
          <text x="60" y="54" textAnchor="middle" fill={scoreColor}
            fontSize="30" fontWeight="800" fontFamily="Syne,sans-serif">{score}</text>
          <text x="60" y="68" textAnchor="middle" fill="rgba(255,255,255,.3)"
            fontSize="10" fontFamily="DM Sans,sans-serif">/100</text>
          <text x="60" y="82" textAnchor="middle" fill="rgba(255,255,255,.35)"
            fontSize="7.5" letterSpacing="1.5" fontFamily="DM Sans,sans-serif">AI READINESS</text>
        </svg>
      </div>
      <div className={styles.scoreHeroText}>
        ...
        <div className={styles.scoreHeroDesc}>
          {scoreDesc} Fix the{" "}
          <strong style={{ color:"#ffb703" }}>{aiData?.critical_issues || 4} critical issues</strong>{" "}
          below to reach <strong style={{ color:"#00f5a0" }}>68+</strong>.
        </div>
