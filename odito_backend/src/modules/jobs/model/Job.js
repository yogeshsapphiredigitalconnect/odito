...
const jobSchema = new mongoose.Schema({
  jobType: {
    type: String,
    required: true,
    enum: ['LINK_DISCOVERY', 'TECHNICAL_DOMAIN', 'PAGE_SCRAPING', 'CRAWL_GRAPH', 'PAGE_ANALYSIS', 'PERFORMANCE_MOBILE', 'PERFORMANCE_DESKTOP', 'HEADLESS_ACCESSIBILITY', 'SEO_SCORING', 'AI_VISIBILITY', 'AI_VISIBILITY_SCORING']
  },
  project_id: {
